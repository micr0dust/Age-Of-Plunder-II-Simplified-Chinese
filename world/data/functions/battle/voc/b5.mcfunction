...
summon minecraft:shulker 78 30 -135 {Color:8,CustomName:"树林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
...
summon minecraft:shulker 78 30 -153 {Color:14,CustomName:"红方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:100}],Health:100.0f,Tags:["red3","building","horse"],Team:red}
summon minecraft:shulker 42 30 -153 {Color:14,CustomName:"红方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:100}],Health:100.0f,Tags:["red3","building","horse"],Team:red}
summon minecraft:shulker 105 30 -162 {Color:8,CustomName:"树林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
summon minecraft:shulker 96 30 -162 {Color:8,CustomName:"金矿",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","gold","horse","building"],Team:b}
...
summon minecraft:shulker 60 30 -171 {Color:8,CustomName:"树林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
...
summon minecraft:shulker 60 30 -180 {Color:8,CustomName:"树林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
...
summon minecraft:shulker 96 30 -189 {Color:14,CustomName:"红方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:100}],Health:100.0f,Tags:["red3","building","horse"],Team:red}
summon minecraft:shulker 78 30 -189 {Color:8,CustomName:"树林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
...
summon minecraft:shulker 78 30 -198 {Color:8,CustomName:"树林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
summon minecraft:shulker 69 30 -198 {Color:8,CustomName:"树林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
...
title @a subtitle ["",{"text":"- 爪哇战争 -","color":"red"}]
