...
#奇觀倒數檢測
execute @e[tag=cmd,c=1,score_canend_min=1,score_mode=6,score_mode_min=6] ~ ~ ~ execute @e[tag=bluew,c=1] ~ ~ ~ scoreboard players operation §9奇观倒数 scores = @e[tag=cmd] bwonder_count
execute @e[tag=cmd,c=1,score_canend_min=1,score_mode=6,score_mode_min=6] ~ ~ ~ execute @e[tag=redw,c=1] ~ ~ ~ scoreboard players operation §c奇观倒数 scores = @e[tag=cmd] rwonder_count
