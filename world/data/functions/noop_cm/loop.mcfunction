...
scoreboard objectives add scores dummy 游戏资讯
scoreboard objectives setdisplay sidebar scores
scoreboard players operation §9累计分数 scores = @e[tag=cmd] bp
scoreboard players operation §c累计分数 scores = @e[tag=cmd] rp
