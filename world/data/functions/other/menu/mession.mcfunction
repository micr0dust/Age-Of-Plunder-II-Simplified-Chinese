...
execute @e[tag=cmd,score_cls_min=4,score_cls=4,score_dom_min=2,score_dom=2,score_difficulty_min=2,score_difficulty=2] ~ ~ ~ tellraw @a ["",{"translate":"aop.other.messions","color":"red"},{"translate":"aop.main.endgame.def1","color":"green"},{"text":"40","color":"green"},{"translate":"aop.round","color":"green"}]
execute @e[tag=cmd,score_cls_min=4,score_cls=4,score_dom_min=2,score_dom=2,score_difficulty_min=3,score_difficulty=3] ~ ~ ~ tellraw @a ["",{"translate":"aop.other.messions","color":"red"},{"translate":"aop.main.endgame.def1","color":"green"},{"text":"50","color":"green"},{"translate":"aop.round","color":"green"}]
execute @e[tag=cmd,score_cls_min=4,score_cls=4,score_dom_min=2,score_dom=2,score_difficulty_min=4,score_difficulty=4] ~ ~ ~ tellraw @a ["",{"translate":"aop.other.messions","color":"red"},{"translate":"aop.main.endgame.def1","color":"green"},{"text":"55","color":"green"},{"translate":"aop.round","color":"green"}]
#2-5.爪哇戰爭
